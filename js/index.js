...
setInterval(() => {
	switch (current) {
		case 1:
			currentImage.src = "images/ケチャ.JPG";
			slider1.classList.toggle("current");
			slider2.classList.toggle("current");
			current++;
			break;
		case 2:
			currentImage.src = "images/スマランのモスク.JPG";
			slider2.classList.toggle("current");
			slider3.classList.toggle("current");
			current++;
			break;
		case 3:
			currentImage.src = "images/ボロブドゥール.JPG";
			slider3.classList.toggle("current");
			slider4.classList.toggle("current");
			current++;
			break;
		case 4:
			currentImage.src = "images/ボロブドゥール上から.JPG";
			slider4.classList.toggle("current");
			slider5.classList.toggle("current");
			current++;
			break;
		case 5:
			currentImage.src = "images/ディエン.JPG";
			slider5.classList.toggle("current");
			slider6.classList.toggle("current");
			current++;
			break;
		case 5:
			currentImage.src = "images/ペニダ島.JPG";
			slider6.classList.toggle("current");
			slider1.classList.toggle("current");
			current = 1;
			break;
